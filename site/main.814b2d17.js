...
this.wordle = this.wordle || {}, this.wordle.bundle = function(e) {
    ...
    function ee(e) {
        return !(!D(e) || (s = e, Y && Y in s)) && (B(e) ? Z : J).test(function(e) {
            if (null != e) {
                try {
                    return U.call(e)
                } catch (e) {}
        ...
        if (d) pe(e, a, d);
            ...
            if (p) {
                ...
                c = l, m || h || y ? Me(i) ? c = i : Ee(u = i) && Re(u) ? c = function(e, s) {
                    ...
                    return "function" == typeof a && a instanceof a && Be.call(a) == We
                }(l) || Ce(l) ? (c = i, Ce(i) ? c = ds(i) : D(i) && !B(i) || (c = function(e) {
    ...
    function cs(e, s, a, t, o) {
        e !== s && he(s, (function(r, n) {
            if (o || (o = new de), D(r)) us(e, s, n, a, cs, t, o);
            else {
    ...
    function Rs(e, s) {
        var a = new Date(e),
            t = new Date(s).setHours(0, 0, 0, 0) - a.setHours(0, 0, 0, 0);
    ...
    var Js = "IN_PROGRESS",
        ...
        Qs = function(e) {
            ...
            function t() {
                ...
                var o = zs();
                return e.lastPlayedTs = o.lastPlayedTs, !e.lastPlayedTs || Rs(new Date(e.lastPlayedTs), e.today) >= 1 ? (e.boardState = new Array(6).fill(""), e.evaluations = new Array(6).fill(null), e.solution = todaySolution, e.lastCompletedTs = o.lastCompletedTs, e.hardMode = o.hardMode, e.restoringFromLocalStorage = !1, js({
                    rowIndex: e.rowIndex,
            ...
            return o(t, [{
                    ...
                    if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                        ...
                        if (this.hardMode) {
                            var t = function(e, s, a) {
                                    ...
                                    for (var o, r, n, i = {}, l = 0; l < a.length; l++)[Is, Ts].includes(a[l]) && (i[s[l]] ? i[s[l]] += 1 : i[s[l]] = 1);
                        ...
                        var n = function(e, s) {
                            for (var a = Array(s.length).fill("absent"), t = Array(s.length).fill(!0), o = Array(s.length).fill(!0), r = 0; r < e.length; r++) e[r] === s[r] && o[r] && (a[r] = Is, t[r] = !1, o[r] = !1);
                ...
                value: function() {
                    var e = this.$game.querySelector("game-modal"),
                        s = document.createElement("game-stats");
                    this.rowIndex <= 6 && s.setAttribute("highlight-guess", this.rowIndex), e.appendChild(s), e.setAttribute("open", "")
                }
            }, {
                key: "showHelpModal",
                value: function() {
                ...
                value: function() {
                    ...
                    this.$game.addEventListener("game-key-press", (function(s) {
                        var a = s.detail.key;
                        "â†" === a || "Backspace" === a ? e.removeLetter() : "â†µ" === a || "Enter" === a ? e.submitGuess() : Ns.includes(a.toLowerCase()) && e.addLetter(a.toLowerCase())
                    ...
                    this.shadowRoot.appendChild(sa.content.cloneNode(!0)), this.$keyboard = this.shadowRoot.getElementById("keyboard"), this.$keyboard.addEventListener("click", (function(s) {
                        ...
                        a.classList.add("row"), s.forEach((function(e) {
                            ...
                            if (e >= "a" && e <= "z" || "â†" === e || "â†µ" === e) {
                                if ((s = aa.content.cloneNode(!0).firstElementChild).dataset.key = e, s.textContent = e, "â†" === e) {
                                    var t = document.createElement("game-icon");
                                    t.setAttribute("icon", "backspace"), s.textContent = "", s.appendChild(t), s.classList.add("one-and-a-half")
                                }
                                "â†µ" == e && (s.textContent = "enter", s.classList.add("one-and-a-half"))
